...
object ProfileManager {
    ...
    {
        var smth = context.getSharedPreferences("CurrentUser", Context.MODE_PRIVATE)
    ...
    public fun Clear()
    {
        context.getSharedPreferences("CurrentUser", Context.MODE_PRIVATE).edit().remove("user").apply()
    }
}